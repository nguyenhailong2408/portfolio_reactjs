...
const cvDataEn = {
  ...
  skill: [
    ...
    },
    {
      name: 'Soft Skills',
      skills:
        'Teamwork, Communication, Problem-solving, Time Management, Adaptability, Critical Thinking, Continuous Learning',
    },
  ],
  ...
  experiences: [
      ...
      projects: [
        {
          ...
          responsibilities: [
            'Developed and deployed the web application using ASP.NET MVC.',
            'Designed and managed the database with MS SQL Server.',
            'Built backend APIs using Entity Framework for Web, Desktop, and Mobile versions.',
            'Designed responsive UI using HTML, CSS, JavaScript, jQuery, Bootstrap.',
            'Managed the project, assigned tasks, provided technical support, and reviewed code for team members.',
          ],
          techStack:
    ...
    },
    {
      ...
      description: [
        ...
        'Developed UI using HTML, CSS, Bootstrap, jQuery, and JavaScript.',
      ],
      projects: [
        {
          ...
          responsibilities: [
            'Developed and deployed web applications from scratch using ASP.NET MVC.',
            'Built backend APIs and managed databases with Entity Framework and MS SQL Server.',
            'Developed user interfaces using HTML, CSS, jQuery, and JavaScript.',
          ],
          techStack:
            'ASP.NET MVC, Entity Framework, MS SQLSERVER, IIS Server, HTML, CSS, Jquery, Javascript, Bootstrap, Razor, LinQ',
  ...
  education: [
    {
      ...
      school: 'HCMC Industry and Trade College',
  ...
  certificates: [
    {
      ...
      organization: 'HCMC Industry and Trade College',
      date: '12/2018',
      proficiency: 'Level B',
      abilities: 'Able to read, understand, and write technical documents in English',
    },
  ],
}

export default cvDataEn
