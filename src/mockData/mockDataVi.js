...
const cvDataVi = {
  ...
  email: 'nguyenhailong2408@gmail.com',
  phone: '0336389966',
  cvonline: 'https://nguyenhailong2408.github.io/portfolio_reactjs/',
  ...
  skill: [
    {
      name: 'Fontend',
      skills: 'HTML, CSS, JavaScript, Jquery, Ajax, Bootstrap, Tailwind CSS, Kendo UI, AngularJS, ReactJS',
    },
    {
      name: 'Backend',
      skills: 'C#, ASP.NET, .NET Core, REST API, SOAP, Linq, Entity Framework, Razor (View Engine), Dapper, Winform',
    },
    {
      name: 'Database',
    ...
    {
      name: 'Tools & Other',
      skills: 'Git, Gitlab, Jira, Trello, Agile, Scrum'
    },
    {
      name: 'Kỹ năng mềm',
      skills:
        'Làm việc nhóm, Giao tiếp, Giải quyết vấn đề, Quản lý thời gian, Thích nghi, Tư duy phản biện, Học hỏi liên tục',
    },
  ],
  languages: ['Tiếng Việt (bản ngữ)', 'Tiếng Anh (trung cấp)'],
  experiences: [
    {
      ...
      description: [
        'Phối hợp với BA, DBA, QA để phát triển, triển khai, bảo trì, nâng cấp, kiểm thử và tối ưu phần mềm (mua hàng - chia hàng - cân hàng - giao tiếp với NCC) thuộc hệ thống ERP cho hơn 3000 siêu thị trên toàn quốc.',
        'Bảo trì, tối ưu và nâng cấp các module và chức năng hiện có trong hệ thống ERP Winform.',
    ...
    {
      position: 'Mid-level Software Developer / Leader Fresher',
      ...
      projects: [
        {
          ...
          role: 'Leader Fresher / Full Stack Developer',
          responsibilities: [
            'Phát triển và triển khai ứng dụng web với ASP.NET MVC.',
            'Thiết kế và quản lý cơ sở dữ liệu với MS SQL Server.',
            'Xây dựng API backend bằng Entity Framework cho cả 3 phiên bản Website, Window, Mobile.',
            'Thiết kế giao diện người dùng UI responsive với HTML, CSS, JavaScript, jQuery, Bootstrap.',
            'Quản lý dự án, phân chia công việc, hỗ trợ kỹ thuật, review code cho thành viên trong nhóm.',
          ],
          techStack:
    ...
    },
    {
      ...
      description: [
        'Tiếp nhận, phân tích, thiết kế hệ thống từ Leader / PM.',
        'Nghiên cứu và phát triển ứng dụng mobile với React Native.',
        'Phát triển và triển khai ứng dụng web từ đầu bằng ASP.NET MVC.',
        'Xây dựng API backend và quản lý cơ sở dữ liệu với Entity Framework, MS SQL Server.',
        'Hợp tác với designer và editor phát triển nội dung số và giao diện.',
        'Phát triển UI bằng HTML, CSS, jQuery và JavaScript.',
      ],
      projects: [
        {
        ...
        },
        {
          ...
          responsibilities: [
            'Phát triển và triển khai ứng dụng web từ đầu bằng ASP.NET MVC.',
            'Xây dựng API backend và quản lý cơ sở dữ liệu bằng Entity Framework, MS SQL Server.',
            'Phát triển giao diện người dùng với HTML, CSS, Bootstrap, jQuery và JavaScript.',
          ],
          techStack:
            'ASP.NET MVC, Entity Framework, MS SQLSERVER, IIS Server, HTML, Css, Jquery, Javascript, Bootstrap, Razor, LinQ',
  ...
  education: [
    {
      ...
      school: 'Cao đẳng Công Thương TP. Hồ Chí Minh',
      year: '10/2015 - 02/2019',
    },
  ],
  certificates: [
    {
      name: 'Tiếng Anh',
      organization: 'Cao đẳng Công Thương TP. Hồ Chí Minh',
      date: '12/2018',
      proficiency: 'B',
      abilities: 'Có khả năng đọc hiểu và viết tài liệu chuyên ngành',
    },
  ],
}

export default cvDataVi
