      ...
      <Page size='A4' style={styles.page}>
        <View>
          ...
          <View style={styles.main}>
            ...
            <View className='boxSection project' style={styles.boxSection}>
              <View className='boxSectionTitle' style={styles.boxSectionTitle}>
                <View style={styles.markIcon_title} />
                <Text style={styles.sectionTitle}>{translations.project}</Text>
              </View>
              <View className='lineTitle' style={styles.lineTitle} />
                          ...
                          <View style={styles.table}>
                            {keys.map((key, k) => {
                              ...
                              switch (key) {
                                case 'url':
                                  return (
                                    <View key={k} className='desProject' style={styles.tableRow} wrap={false}>
                                ...
                                case 'AppStore':
                                  return (
                                    <View key={k} className='desProject' style={styles.tableRow} wrap={false}>
                                      <View style={{ ...styles.tableCol, ...styles.tableColLeft }}>
                                        <Text style={{ ...styles.text, ...styles.tableCell, fontWeight: 'semibold' }}>
                                          {translations[key]}:{' '}
                                        </Text>
                                      </View>
                                      <View style={{ ...styles.tableCol, ...styles.tableColRight }}>
                                      ...
                                      <View style={{ ...styles.tableCol, ...styles.tableColRight }}>
                                        <Text
                                          style={{
                                            ...styles.text,
                                            ...styles.tableCell,
                                            fontWeight: key === 'company' ? 'semibold' : 'light',
                                          }}
                                        >
                                          {proj[key]}
                                        </Text>
              ...
              {data.personalProjects.map((personalProj, i) => (
                ...
                >
                  ...
                  >
                    ...
                    <Text style={{ ...styles.text }}>{personalProj.description}</Text>
                  </View>
                </View>
              ))}
            </View>
              ...
              {data.certificates.map((certificate, i) => (
                ...
                >
                  ...
                  >
                    ...
                    <Text style={{ ...styles.text }}>{certificate.organization}</Text>
                    <Text style={{ ...styles.text }}>
                      {translations.profciency}: {certificate.proficiency}
                    </Text>
                    <Text style={{ ...styles.text }}>{certificate.abilities}</Text>
                  </View>
                </View>
              ))}
            </View>
