...
export default function CVViewer({ data, translations }) {
  return (
        ...
        <div className='w-full md:pl-5'>
          ...
          <div className='boxSection pt-2 pb-2'>
            <div className='boxSectionTitle flex items-center mb-1'>
              ...
              <h3 className='text-sm md:text-base font-lexend-semibold uppercase text-rose-700'>{translations.skill}</h3>
            </div>
          ...
          <div className='boxSection pt-2 pb-2'>
            <div className='boxSectionTitle flex items-center mb-1'>
              <div className='w-2 h-2 bg-rose-700 rotate-45 mr-2 ml-1'></div>
              <h3 className='text-sm md:text-base font-lexend-semibold uppercase text-rose-700'>{translations.education}</h3>
            </div>
            <div className='w-[calc(100%-1rem)] h-px bg-gray-300 mb-2 ml-4 mr-4'></div>
          ...
          <div className='boxSection pt-2 pb-2'>
            <div className='boxSectionTitle flex items-center mb-1'>
              <div className='w-2 h-2 bg-rose-700 rotate-45 mr-2 ml-1'></div>
              <h3 className='text-sm md:text-base font-lexend-semibold uppercase text-rose-700'>{translations.experience}</h3>
            </div>
            <div className='w-[calc(100%-1rem)] h-px bg-gray-300 mb-2 ml-4 mr-4'></div>
            {data.experiences.map((experience, i) => (
              <div key={i}>
                ...
                {Array.isArray(experience.projects) && experience.projects.length > 0 && (
                  <div className='flex justify-end mb-2'>
                    <div className='flex items-start mr-6 w-1/5'>
                      <div className='w-1 h-1 bg-gray-400 rotate-45 mt-1.5 mr-1.5 ml-1'></div>
                      <span className='font-lexend-semibold'>{translations.project}</span>
                    </div>
                        ...
                        return (
                          <div key={j} className='flex flex-col flex-wrap mb-1'>
                            <div className='flex items-center w-full'>
                              ...
                              <span className='h-3 border-l border-black mx-2'></span>
                              <span>{proj.duration}</span>
                            </div>
                            {keys.map((key, k) => {
                              if (key === 'name' || key === 'duration') return null
                              return (
                                <div key={`${j}-${k}`} className='flex flex-col ml-2'>
                                      ...
                                      switch (key) {
                                        case 'url':
                                          return (
                                            <>
                                              <div className='w-1 h-1 min-w-[4px] min-h-[4px] rounded-full bg-black mt-1.5'></div>
                                              <p className='font-lexend-semibold'>
                                        ...
                                        case 'AppStore':
                                          return (
                                            <>
                                              ...
                                              <p className='font-lexend-semibold'>
                                                {translations[key] || key}:{' '}
                                                <a href={proj[key]} className='underline text-blue-600 break-all'>
                                                  {proj[key]}
                                                </a>
                                              </p>
                                            </>
            ...
            {data.personalProjects.map((personalProj, i) => (
              <div key={i} className='flex justify-end mb-2'>
                ...
                <div className='flex flex-col w-3/4'>
                  ...
                  <span className='font-normal'>{personalProj.description}</span>
                </div>
              </div>
            ))}
          </div>
            ...
            {data.certificates.map((certificate, i) => (
              <div key={i} className='flex justify-end mb-2'>
                ...
                <div className='flex flex-col w-3/4'>
                  ...
                  <span className='font-normal'>{certificate.abilities}</span>
                </div>
              </div>
            ))}
          </div>
